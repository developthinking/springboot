...
import com.wuti.demo.domain.User;
...
public class TestRedisTemplate {
    ...
    public void testString()  {
		redisTemplate.opsForValue().set("wt", "wt");
        redisTemplate.opsForValue().set("wt", "hello");
        redisTemplate.opsForValue().set("wt", "阿题");
	}*/
	
	/*@Test
    public void testObj(){
        User user=new User("wt@126.com", "rover", "123456", "wt","2018-06-08");
        ValueOperations<String, User> operations=redisTemplate.opsForValue();
        operations.set("com.wuti", user);
        User u=operations.get("com.wuti");
	...
	public void testDelete() {
	    ValueOperations<String, User> operations=redisTemplate.opsForValue();
	    redisTemplate.opsForValue().set("deletekey", "wt");
